...
export interface ApiAboutCompanyAboutCompany extends Schema.SingleType {
  ...
  attributes: {
    about_img: Attribute.Media<'images'>;
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blog_img: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    blog_desc: Attribute.Text;
    publish_time: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiContactContact extends Schema.SingleType {
  ...
  attributes: {
    contact_adress: Attribute.String;
    contact_phone_1: Attribute.String;
    contact_phone_2: Attribute.String;
    contact_map_iframe: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiContactformContactform extends Schema.CollectionType {
  ...
  attributes: {
    contactform_name: Attribute.String;
    contactform_number: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiHeaderPhoneHeaderPhone extends Schema.SingleType {
  collectionName: 'header_phones';
  info: {
    singularName: 'header-phone';
    pluralName: 'header-phones';
    displayName: '\u0422\u0435\u043B\u0435\u0444\u043E\u043D \u043D\u043E\u043C\u0435\u0440';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    header_phone_number: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::header-phone.header-phone',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    cover_title: Attribute.String;
    cover_desc: Attribute.Text;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    product_desc: Attribute.Text;
    product_img: Attribute.Media<'images'>;
    product_25_price: Attribute.String;
    product_50_price: Attribute.String;
    product_70_price: Attribute.String;
    home_page: Attribute.Boolean;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::header-phone.header-phone': ApiHeaderPhoneHeaderPhone;
